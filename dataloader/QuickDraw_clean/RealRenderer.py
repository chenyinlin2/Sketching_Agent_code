...
class GizehRasterizor(object):
    ...
    def load_sketch_images_on_the_fly_v2(self, image_size, norm_strokes3, stroke_width, is_bin=True):
        ...
        for stroke_i in range(len(norm_strokes3)):
            ...
            sketch_img = self.get_line_array_v2(image_size, seq_strokes3, stroke_width=stroke_width, is_bin=is_bin)#小于128设置为0，其他等于1
    ...
    def raster_func(self, input_data, image_size, stroke_width, is_bin=True, version='v2'):
        ...
        """
        norm_test_strokes3 = self.normalize_strokes_np(input_data, image_size)#list[1] for array[n,3] 对于不同图片，有不同的笔划，即n
        if version == 'v1':
        ...
        return raster_image_array#list of [image_size,image_size]
