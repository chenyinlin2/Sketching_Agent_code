...
def array2samples_distance(array1, array2):
    ...
    expanded_array1 = np.tile(array1, (num_point, 1))#[20,4] -> [400,4]
    expanded_array2 = np.reshape(
            np.tile(np.expand_dims(array2, 1),
                    (1, num_point, 1)),
            (-1, num_features))#[20,4] -> [400,4]
    # distances = LA.norm(expanded_array1-expanded_array2, axis=1)
    distances = np.linalg.norm(expanded_array1-expanded_array2, axis=1)#400
...
if __name__ == '__main__':
    ...
    print('numpy: ', chamfer_distance_numpy(array2,array1))